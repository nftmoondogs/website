...
<div className={`${layout.sectionInfo} sm:flex drop-shadow-2xl sm:pt-52 sm:pb-0 sm:pr-32`}>
  <h2 className={`${styles.heading5}`}>Aptos Dogs are 
 <br className="sm:block hidden" /> more than just an avatar.</h2>
  <p className={`${styles.paragraph} pt-6 sm:pb-96 pt-0.5`}>
  They're a collection of 5000 utility-enabled PFPs that feature a richly diverse and unique pool of rarity-powered traits. What's more, each Aptos Dog unlocks private club membership and additional benefits the longer you hold them.
  </p>
